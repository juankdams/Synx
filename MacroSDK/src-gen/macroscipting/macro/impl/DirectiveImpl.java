 ...
 * <ul>
 *   <li>{@link macroscipting.macro.impl.DirectiveImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DirectiveImpl extends MinimalEObjectImpl.Container implements Directive
{
  ...
  {
    return MacroPackage.Literals.DIRECTIVE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MacroPackage.DIRECTIVE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MacroPackage.DIRECTIVE__NAME:
        return getName();
    }
