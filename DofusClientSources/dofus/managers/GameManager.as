...
if (!dofus.managers.GameManager)
{
    ...
    _loc1.startExchange = function (nExchangeType, sSpriteID, nCellNum)
    {
        ...
        if (_loc5.isInMove)
        {//Si le personnage est en train de bouger lorsqu'il lance un dialogue, annule le mouvement et envoie le GKE avec la cell courante du joueur
