        ...
        switch (sType)
        {
            ...
            case "G":
            {
                switch (sAction)
                {
                    ...
                    case "E":
                    {
                        this.aks.Game.onEnd(sData.substr(2));//Panel d'xp, drop, gagnants/perdants etc de fin de combat.
                        break;
                    } 
                    case "M":
                    {
                    ...
                    case "c":
                    {
                        this.aks.Game.onChallenge(sData.substr(2)); //Lorsqu'on start un combat, Challenge = le combat. 
                        break;										//Cette fonction sers à afficher les épées de combat sur la map pour pouvoir rejoindre le combat.
                    } 
                    case "t":
                    {
                    ...
                    case "f":
                    {
                        this.aks.Game.onFlag(sData.substr(2));//= lorsqu'on pointe une cellule dans un combat 
                        break;
                    } 
                    case "I":
                    {
            ...
            case "f":
            {
                switch (sAction)
                {
                    case "C":
                    {
                        this.aks.Fights.onCount(sData.substr(2));//fait
                        break;
                    } 
                    case "L":
                    {
