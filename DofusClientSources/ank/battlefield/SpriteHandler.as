...
if (!ank.battlefield.SpriteHandler)
{
    ...
    _loc1.initialize = function (b, c, d)
    {
        ...
        this._oSprites = d;//d étant le Dofus.Datacenter.Sprites
        this._mcContainer = c;
    };
    ...
    _loc1.addSprite = function (sID, oSprite)
    {
        ...
        var _loc5 = ank.battlefield.utils.SpriteDepthFinder.getFreeDepthOnCell(this._mcBattlefield.mapHandler, this._oSprites, oSprite.cellNum, this._mcBattlefield.bGhostView);
        ...
        if (this._mcBattlefield.bGhostView)
        {
    ...
    {
        var _loc10 = this._oSprites.getItemAt(sID);//sID = spellID... loc10 = Spell
        if (_loc10 == undefined)
        {
