...
if (!dofus.managers.CharactersManager)
{
    ...
    _loc1.createCharacter = function (sID, sName, oData)
    {
        ...
        if (_loc5 == undefined)
        {
            _loc5 = new dofus.datacenter.Character(sID, ank.battlefield.mc.Sprite, dofus.Constants.CLIPS_PERSOS_PATH + oData.gfxID + ".swf", oData.cell, oData.dir, oData.gfxID);
    ...
    _loc1.getItemObjectFromData = function (sData)
    {
        ...
        var _loc4 = _global.parseInt(_loc3[0], 16);//ID
        var _loc5 = _global.parseInt(_loc3[1], 16);//TemplateID
        var _loc6 = _global.parseInt(_loc3[2], 16);//Quantity
        var _loc7 = _loc3[3].length == 0 ? (-1) : (_global.parseInt(_loc3[3], 16));//Position
        var _loc8 = _loc3[4];//Effects
