...
if (!dofus.graphics.battlefield.DofusBattlefield)
{
    ...
    _loc1.onSpriteRollOver = function (mcSprite)
    {
        ...
        {
            var _loc7 = this.mapHandler.getCellData(_loc5.cellNum).mc;
            if (_loc5.isVisible)
            {
                this.onCellRollOver(_loc7);
            } // end if
        } // end if
        var _loc8 = _loc5.name;
        if (_loc5 instanceof dofus.datacenter.Mutant && _loc5.showIsPlayer)
        {
            if (this.api.datacenter.Game.isRunning)
            {
                _loc8 = _loc5.playerName + " (" + _loc5.LP + ")";
                this.showSpriteInfosIfWeNeed(_loc5);
            }
            else
            {
                _loc8 = _loc5.playerName + " [" + _loc5.monsterName + " (" + _loc5.Level + ")]";
            } // end else if
        }
        else if (_loc5 instanceof dofus.datacenter.Mutant || (_loc5 instanceof dofus.datacenter.Creature || _loc5 instanceof dofus.datacenter.Monster))
        {
            ...
            if (this.api.datacenter.Game.isRunning)
            {
                _loc8 = _loc8 + (" (" + _loc5.LP + ")");
                this.showSpriteInfosIfWeNeed(_loc5);
            }
            else
            {
                _loc8 = _loc8 + (" (" + _loc5.Level + ")");
            } // end else if
        }
        else if (_loc5 instanceof dofus.datacenter.Character)
        {
            ...
            if (this.api.datacenter.Game.isRunning)
            {
                ...
                if (_loc5.isVisible)
                {
                    var _loc9 = _loc5.EffectsManager.getEffects();
                    if (_loc9.length != 0)
                    {
                        this.addSpriteOverHeadItem(_loc5.id, "effects", dofus.graphics.battlefield.EffectsOverHead, [_loc9]);
                    } // end if
                } // end if
                this.showSpriteInfosIfWeNeed(_loc5);
            }
            ...
            var _loc10 = _loc5.haveFakeAlignement ? (_loc5.fakeAlignment.index) : (_loc5.alignment.index);
            ...
            {
                _loc8 = "";
                this.addSpriteOverHeadItem(_loc5.id, "text", dofus.graphics.battlefield.GuildOverHead, [_loc5.guildName, _loc5.name, _loc5.emblem, _loc3, _loc4, _loc5.pvpGain], undefined, true);
            } // end if
        }
        ...
        else if (_loc5 instanceof dofus.datacenter.PrismSprite)
        {
            ...
            _loc6 = dofus.Constants.NPC_ALIGNMENT_COLOR[_loc5.alignment.index];
            this.addSpriteOverHeadItem(_loc5.id, "text", dofus.graphics.battlefield.TextOverHead, [_loc8, _loc3, _loc6, _loc4]);
        }
        else if (_loc5 instanceof dofus.datacenter.ParkMount)
        {
            _loc6 = dofus.Constants.OVERHEAD_TEXT_CHARACTER;
            _loc8 = this.api.lang.getText("MOUNT_PARK_OVERHEAD", [_loc5.modelName, _loc5.level, _loc5.ownerName]);
            this.addSpriteOverHeadItem(_loc5.id, "text", dofus.graphics.battlefield.TextOverHead, [_loc8, _loc3, _loc6, _loc4]);
        }
        ...
        {
            var _loc11 = this.api.datacenter.Map;
            var _loc12 = this.api.datacenter.Subareas.getItemAt(_loc11.subarea);
            if (_loc12 != undefined)
            {
                _loc6 = dofus.Constants.NPC_ALIGNMENT_COLOR[_loc12.alignment.index];
            } // end if
        }
        else if (_loc5 instanceof dofus.datacenter.MonsterGroup || _loc5 instanceof dofus.datacenter.Team)
        {
            ...
            var _loc13 = _loc5.challenge.fightType;
            if (_loc5.isVisible && (_loc5 instanceof dofus.datacenter.MonsterGroup || _loc5.type == 1 && (_loc13 == 2 || (_loc13 == 3 || _loc13 == 4))))
            {
                if (_loc8 != "")
                {
                    var _loc14 = dofus.Constants.OVERHEAD_TEXT_TITLE;
                    this.addSpriteOverHeadItem(_loc5.id, "text", dofus.graphics.battlefield.TextWithTitleOverHead, [_loc8, _loc3, _loc6, _loc4, this.api.lang.getText("LEVEL") + " " + _loc5.totalLevel, _loc14, _loc5.bonusValue]);
                } // end if
        ...
        if (_loc5.isVisible)
        {
            if (_loc8 != "")
            {
                this.addSpriteOverHeadItem(_loc5.id, "text", dofus.graphics.battlefield.TextOverHead, [_loc8, _loc3, _loc6, _loc4, _loc5.pvpGain]);
            } // end if
            this.selectSprite(_loc5.id, true);
        } // end if
    };
