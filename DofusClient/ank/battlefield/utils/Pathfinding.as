...
if (!ank.battlefield.utils.Pathfinding)
{
    ...
    }).pathFind = function (mapHandler, nCellBegin, nCellEnd, oParams)
    {
        ...
        if (_loc6)
        {
            var _loc12 = 8;//nombre de directions utilisables
            var _loc13 = [1, _loc11, _loc11 * 2 - 1, _loc11 - 1, -1, -_loc11, -_loc11 * 2 + 1, -(_loc11 - 1)];//loc11 = mapHandler.getWidth();
            var _loc14 = [1.500000E+000, 1, 1.500000E+000, 1, 1.500000E+000, 1, 1.500000E+000, 1];//4 chiffres pour 4 directions
        }
        else
        {
            _loc12 = 4;//nombre de directions utilisables
            _loc13 = [_loc11, _loc11 - 1, -_loc11, -(_loc11 - 1)];//_loc11 = mapHandler.getWidth();
            _loc14 = [1, 1, 1, 1];//4 chiffres pour 4 directions
        } // end else if
