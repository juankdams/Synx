...
public class EffectsManager {
	...
	/**
	 * Vérifie si l'effet est un effet pour consulter le fiche de la monture (effet qui contient d'ailleurs l'ID de la monture en question)
	 */
	public boolean isMountSheetEffect(GEffect e) {
		return aepl.isMountSheetEffect(e);
	}
