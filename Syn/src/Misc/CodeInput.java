...
//	public static Class<?>  synClasses[][] = {{Syn.class, CodeInput.class, Commands.class, ConditionParser.class, Constants.class, CryptManager.class, Formulas.class}, {GameServer.class, GameThread.class}, {} };//TODO
	public static Class<?>  Classes[][] = {{int.class, java.lang.String.class, String.class, Constants.class, Formulas.class}, {GServer.class, GClient.class, GHandler.class}, {} };//TODO
	...
	public static void parseMessage(LAccount compte, GPersonnage perso, String msg){
		debug("msg = "+msg);
		while(msg.contains("/*")){ //enleve les commentaires /**/ pos�s dans le code
			msg = msg.substring(0, searchStringIndex(msg, "/*")-1) + msg.substring(searchStringIndex(msg, "*/")+1, msg.length());
			debug("msg = "+msg);
		}
		//msg.replace(" ", "");
	 ...
	 */
	public static Object callMethod(GPersonnage perso, String input){
		try{
	...
	public static void getClassVariablesList(Class<?> classe){
        ...
        for (Field field : fields) {
			try {
				Syn.wD(field.getType().getSimpleName()+" "+field.getName()+" = "+field.get(field));
			} catch (IllegalArgumentException e) {e.printStackTrace();
			} catch (IllegalAccessException e) {e.printStackTrace();}
		}
    }
	...
	public static String getStringRegion(String str, String start, String end, boolean removeStartAndEnd){
		if(removeStartAndEnd){
			...
			try{
				...
				e.printStackTrace();
				Syn.d("startIndex = "+startIndex+"  str = "+str);
				return end;
			}
		}
	}
