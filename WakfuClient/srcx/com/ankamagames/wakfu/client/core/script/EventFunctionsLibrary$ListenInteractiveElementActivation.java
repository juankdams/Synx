...
class EventFunctionsLibrary$ListenInteractiveElementActivation extends dsg
{
  public EventFunctionsLibrary$ListenInteractiveElementActivation(LuaState paramLuaState)
  {
    super(paramLuaState);
  }
  ...
  protected void S(int paramInt)
  {
    ...
    bXf localbXf = cYS();
    bhD.btQ().a(localbWX, localbXf, str, arrayOfbFB, false);
  }
}