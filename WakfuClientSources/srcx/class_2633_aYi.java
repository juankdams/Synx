  ...
  implements cEa
{
  ...
  public bdj d(bdj parambdj)
  {
    ...
    localNK3.setAttribute("visible");
    localNK3.setName("describedState");
    localNK3.setField("maxLevelValue");
    ...
    localcCu.hg("popup(stateCumulablePopup)");
    ...
    localczv2.brn();
    String str2 = "stateCumulablePopup";
    anG localanG = new anG();
    localanG.aJ();
    ...
    String str3 = "%state.cumulable%";
    str3 = str3.replace("%state.cumulable%", cBQ.cxL().mL("state.cumulable"));
    ...
    localNK8.setName("describedState");
    localNK8.setAttribute("visible");
    localNK8.setField("effectDescription");
    ...
    localNK9.setField("effectDescription");
    localat.bb(localNK9);
    localNK9.brn();
    localNK9.rV();
    eR localeR = new eR();
  ...
  public bdj g(bdj parambdj)
  {
    ...
    localNK1.setAttribute("visible");
    localNK1.setName("describedState");
    localNK1.setField("maxLevelValue");
    localNK1.setLocal(true);
    ...
    bmv localbmv1 = bmv.checkOut();
    localbmv1.setElementMap(localcpa);
    localbmv1.setInsets(new Insets(6, 0, 0, 0));
    localJg1.bb(localbmv1);
    localbmv1.brn();
    localbmv1.rV();
    localJg1.rV();
    ...
    localdis.hg("wakfu.stateDetails:setStateLevel");
    localcvx1.setOnSliderMove(localdis);
    localcvx1.setMinBound(1);
    ...
    localNK2.setName("describedState");
    localNK2.setField("maxLevelValue");
    localNK2.setLocal(true);
    ...
    localNK3.setName("describedState");
    localNK3.setField("levelValue");
    localNK3.setLocal(true);
    localcvx1.bb(localNK3);
    localNK3.brn();
    localNK3.rV();
    cvx localcvx2 = localcvx1;
    Jg localJg4 = localcvx2.getAppearance();
    localJg4.setElementMap(localcpa);
    localcvx1.bb(localJg4);
    localJg4.brn();
    bmv localbmv4 = bmv.checkOut();
    localbmv4.setElementMap(localcpa);
    localbmv4.setInsets(new Insets(5, 2, 5, 0));
    ...
    bmv localbmv5 = bmv.checkOut();
    localbmv5.setElementMap(localcpa);
    localbmv5.setInsets(new Insets(0, 2, 0, 5));
    ...
    localNK4.setAttribute("text");
    localNK4.setName("describedState");
    localNK4.setField("maxLevelValue");
    localNK4.setLocal(true);
    ...
    localdbp.hg("wakfu.stateDetails:keyType(levelTextEditor)");
    ...
    localcsA.hg("wakfu.stateDetails:restore");
