public class bL extends Ui
{
  ...
  public void a(axM paramaxM1, axM paramaxM2)
  {
    ...
    paramaxM2.bOZ = (paramaxM1.bOZ * (this.kT * 0.007874016F) + this.cxC * 0.0039063F);
    paramaxM2.bPa = (paramaxM1.bPa * (this.kU * 0.007874016F) + this.cxD * 0.0039063F);
    paramaxM2.bPb = (paramaxM1.bPb * (this.kV * 0.007874016F) + this.cxE * 0.0039063F);
    paramaxM2.bPc = (paramaxM1.bPc * (this.kW * 0.007874016F) + this.cxF * 0.0039063F);
  }
}