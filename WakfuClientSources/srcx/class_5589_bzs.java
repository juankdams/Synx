...
final class bzs
{
  ...
  private bzs(Xe paramXe) {  } 
  public void z() { this.gnp.cxL = this.cxL;
    this.gnp.aZC.clear();
    this.gnp.aZC.ensureCapacity(this.aZC.size());
    this.gnp.aZC.addAll(this.aZC); }
  ...
  private boolean f(ByteBuffer paramByteBuffer) {
    ...
    for (int j = 0; j < i; j++) {
      ...
      boolean bool = localbKX.b(paramByteBuffer, 1);
      if (!bool)
        return false;
  ...
  private boolean m(ByteBuffer paramByteBuffer) {
    ...
    for (int j = 0; j < i; j++) {
      bKX localbKX = new bKX();
      boolean bool = localbKX.b(paramByteBuffer, 313);
      if (!bool)
        return false;
      this.aZC.add(localbKX);
    }
  ...
  private boolean k(ByteBuffer paramByteBuffer) {
    ...
    for (int j = 0; j < i; j++) {
      bKX localbKX = new bKX();
      boolean bool = localbKX.b(paramByteBuffer, 314);
      if (!bool)
        return false;
      this.aZC.add(localbKX);
    }
  ...
  private boolean n(ByteBuffer paramByteBuffer) {
    ...
    for (int j = 0; j < i; j++) {
      bKX localbKX = new bKX();
      boolean bool = localbKX.b(paramByteBuffer, 315);
      if (!bool)
        return false;
      this.aZC.add(localbKX);
    }
  ...
  private boolean o(ByteBuffer paramByteBuffer) {
    ...
    for (int j = 0; j < i; j++) {
      bKX localbKX = new bKX();
      boolean bool = localbKX.b(paramByteBuffer, 10003);
      if (!bool)
        return false;
      this.aZC.add(localbKX);
    }
  ...
  private boolean r(ByteBuffer paramByteBuffer) {
    ...
    for (int j = 0; j < i; j++) {
      bKX localbKX = new bKX();
      boolean bool = localbKX.b(paramByteBuffer, 10023);
      if (!bool)
        return false;
      this.aZC.add(localbKX);
    }
