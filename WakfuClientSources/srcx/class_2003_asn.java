  ...
  implements cEa
{
  ...
  public bdj g(bdj parambdj)
  {
    ...
    localdRq5.setStyle("AchievementUnlockedSplash");
    localdRq1.bb(localdRq5);
    localdRq5.brn();
    cwP localcwP3 = new cwP();
    localcwP3.aJ();
    localcwP3.setElementMap(localcpa);
    localcwP3.setSize(new Or(311, 135));
    ...
    localNK3.setName("infoView");
    localNK3.setField("title");
  ...
  public bdj h(bdj parambdj)
  {
    ...
    localcsA.hg("wakfu.info:closeDialog");
