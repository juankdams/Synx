...
public class dxf extends dKf
{
  private static final Logger K = Logger.getLogger(dxf.class);
  private int ie;

  public dxf(int paramInt)
  {
    super(paramInt);
  }
  ...
  public void c(String[] paramArrayOfString) {
    this.ie = Integer.parseInt(paramArrayOfString[0]);
  }
