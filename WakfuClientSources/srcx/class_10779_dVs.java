  ...
  implements cxS
{
  ...
  public boolean g(ByteBuffer paramByteBuffer)
  {
    ...
    for (int i = 0; i < this.aZC.size(); i++) {
      oT localoT = (oT)this.aZC.get(i);
      boolean bool = localoT.g(paramByteBuffer);
      if (!bool)
        return false;
    }
    return true;
  ...
  public boolean h(ByteBuffer paramByteBuffer) {
    ...
    for (int j = 0; j < i; j++) {
      oT localoT = new oT();
      boolean bool = localoT.h(paramByteBuffer);
      if (!bool)
        return false;
      this.aZC.add(localoT);
    }
    return true;
  }
  ...
  public final void a(StringBuilder paramStringBuilder, String paramString) {
    ...
    if (this.aZC.isEmpty()) {
      ...
      for (int i = 0; i < this.aZC.size(); i++) {
        oT localoT = (oT)this.aZC.get(i);
        localoT.a(paramStringBuilder, paramString + i + "/ ");
      }
    }
  }
}