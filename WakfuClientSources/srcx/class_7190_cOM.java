  ...
  implements cEa
{
  ...
  public bdj a(cDA paramcDA, cpa paramcpa)
  {
    ...
    String str1 = "%nickname%";
    str1 = str1.replace("%nickname%", cBQ.cxL().mL("nickname"));
    ...
    localcWk3.setStyle("11Mecanic");
    String str3 = "%nickname.choice.explaination.1%";
    str3 = str3.replace("%nickname.choice.explaination.1%", cBQ.cxL().mL("nickname.choice.explaination.1"));
    localcWk3.setText(str3);
    localcWk3.setMinWidth(253);
    localcWk3.setMaxWidth(253);
    ...
    localbmv6.setInsets(new Insets(10, 0, 10, 0));
    ...
    localbmv7.setInsets(new Insets(0, 0, 0, 6));
    ...
    String str4 = "%nickname.choice.explaination.2%";
    str4 = str4.replace("%nickname.choice.explaination.2%", cBQ.cxL().mL("nickname.choice.explaination.2"));
    localcWk4.setText(str4);
    localcWk4.setStyle("11Mecanic");
    ...
    localcsA.hg("wakfu:validateNickname(nickNameTextEditor)");
    ...
    localcuR6.setInsets(new Insets(3, 3, 3, 3));
    ...
    localczv5.setStyle("apply");
    localczv5.setDisplaySize(new Or(16, 16));
    localczv5.setNonBlocking(true);
    localdRq16.bb(localczv5);
    localczv5.brn();
