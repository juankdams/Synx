  ...
  implements cEa
{
  ...
  public bdj a(cDA paramcDA, cpa paramcpa)
  {
    ...
    localNK1.setName("selectedProtectorBudget");
    ...
    localNK2.setName("selectedProtectorBudget");
    ...
    String str4 = "%protector.budgetToAllocate%";
    str4 = str4.replace("%protector.budgetToAllocate%", cBQ.cxL().mL("protector.budgetToAllocate"));
    ...
    localdbp.hg("wakfu.protectorManagement:validateBudgetAllocation(confirmButton)");
    ...
    localNK3.setField("walletHandler/totalAmount");
    ...
    localcuR5.setInsets(new Insets(7, 7, 7, 7));
    ...
    localcsA2.hg("wakfu.protectorManagement:allocateBudget(amountTextEditor,wallet)");
    ...
    Jg localJg13 = localbiy4.getAppearance();
    localJg13.setElementMap(localcpa);
    localbiy3.bb(localJg13);
    localJg13.brn();
    cuR localcuR6 = new cuR();
    localcuR6.aJ();
    localcuR6.setElementMap(localcpa);
    localcuR6.setInsets(new Insets(7, 7, 7, 7));
