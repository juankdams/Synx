  ...
  implements cEa
{
  ...
  public bdj a(cDA paramcDA, cpa paramcpa)
  {
    ...
    localbpn.setPrefSize(new Or(0, 47));
  ...
  public bdj q(bdj parambdj)
  {
    ...
    localcuR1.setInsets(new Insets(1, 10, 1, 10));
    ...
    localccG1.setPrefSize(new Or(0, 31));
    localccG1.setScrollBar(false);
    localccG1.setCellSize(new Or(31, 39));
    ...
    localcuR2.setInsets(new Insets(4, 0, 4, 0));
    ...
    NK localNK3 = NK.checkOut();
    localNK3.setElementMap(localcpa);
    localNK3.setAttribute("dragEnabled");
    localNK3.setName("isInFight");
    localbXx2.bb(localNK3);
    localNK3.brn();
    anQ localanQ3 = new anQ();
    localanQ3.aJ();
    localanQ3.setElementMap(localcpa);
    ...
    Jg localJg3 = localbXx3.getAppearance();
    localJg3.setElementMap(localcpa);
    localbXx2.bb(localJg3);
    localJg3.brn();
    bmv localbmv1 = bmv.checkOut();
    localbmv1.setElementMap(localcpa);
    ...
    localaaE1.setField("backgroundTypeIcon");
    ...
    localdRq7.setStyle("fighterControlsNotAllowed");
    localbXx2.bb(localdRq7);
    localdRq7.brn();
    cwP localcwP6 = new cwP();
    localcwP6.aJ();
    localcwP6.setElementMap(localcpa);
    localcwP6.setSize(new Or(31, 31));
    ...
    localaaE4.setAttribute("usedInLayout");
    ...
    localaaE5.setField("cooldown");
    localcWk.bb(localaaE5);
    localaaE5.brn();
    localaaE5.rV();
    localcWk.rV();
    localbXx2.rV();
    ...
    localNK5.setName("shortcutBar");
    localNK5.setAttribute("text");
    localNK5.setField("indexText");
    ...
    localccG2.setPrefSize(new Or(0, 31));
    localccG2.setScrollBar(false);
    localccG2.setCellSize(new Or(31, 39));
