  ...
  implements aTK
{
  ...
  public void a(cpa paramcpa, uk paramuk, dOc paramdOc)
  {
    ...
    ((cwJ)localJg1).setAlignment(aFG.ecn);
    localJg1.setState("default");
    paramdOc.bb(localJg1);
    localJg1.brn();
    aAR localaAR1 = aAR.checkOut();
    localaAR1.setElementMap(localcpa);
    localaAR1.setPosition(ajb.dif);
    localaAR1.setX(680);
    localaAR1.setY(846);
    localaAR1.setWidth(160);
    localaAR1.setHeight(176);
    localaAR1.setTexture(this.W.aH("preWorld_2.tga"));
    ...
    ((cwJ)localJg2).setAlignment(aFG.ecn);
    localJg2.setState("mouseHover");
    paramdOc.bb(localJg2);
    localJg2.brn();
    aAR localaAR2 = aAR.checkOut();
    localaAR2.setElementMap(localcpa);
    localaAR2.setPosition(ajb.dif);
    localaAR2.setX(510);
    localaAR2.setY(96);
    localaAR2.setWidth(160);
    localaAR2.setHeight(176);
    ...
    ((cwJ)localJg3).setAlignment(aFG.ecn);
    localJg3.setState("pressed");
    paramdOc.bb(localJg3);
    localJg3.brn();
    aAR localaAR3 = aAR.checkOut();
    localaAR3.setElementMap(localcpa);
    localaAR3.setPosition(ajb.dif);
    localaAR3.setX(713);
    localaAR3.setY(52);
    localaAR3.setWidth(160);
    localaAR3.setHeight(176);
