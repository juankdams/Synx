  ...
  implements aTK
{
  ...
  public void a(cpa paramcpa, uk paramuk, dOc paramdOc)
  {
    ...
    localaAR1.setX(287);
    localaAR1.setY(27);
    localaAR1.setWidth(63);
    localaAR1.setHeight(48);
    localaAR1.setTexture(this.W.aH("worldEditor_0.tga"));
    ...
    localaAR2.setX(287);
    localaAR2.setY(78);
    localaAR2.setWidth(63);
    localaAR2.setHeight(48);
    localaAR2.setTexture(this.W.aH("worldEditor_0.tga"));
    ...
    localaAR3.setX(99);
    localaAR3.setY(20);
    localaAR3.setWidth(63);
    localaAR3.setHeight(48);
    localaAR3.setTexture(this.W.aH("worldEditor_0.tga"));
    ...
    localaAR4.setX(353);
    localaAR4.setY(27);
    localaAR4.setWidth(63);
    localaAR4.setHeight(48);
    localaAR4.setTexture(this.W.aH("worldEditor_0.tga"));
