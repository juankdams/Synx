...
public class Messages{
	 ...
	 */
	public static void MIP(LoginServer s, String IP, String message, String color){
		for(LAccount c : s.world.getAccounts().values()){
	 ...
	 */
	public static void MS(DofusGameClient perso, String mess)
	{
