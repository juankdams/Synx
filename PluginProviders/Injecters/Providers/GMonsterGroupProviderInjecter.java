...
import GameObjects.GMonsterGroup.GMonsterGroupProvider;
...
public class GMonsterGroupProviderInjecter extends GMonsterGroupProvider implements IProvider, Injecter {
	...
	public GMonsterGroupProviderInjecter(Providers p){
		this.parent = p;
	}
	...
	public GMonsterGroup createNew(GWorld w, short size){
		GMonsterGroup mg = new GMonsterGroup(size);
	...
	public GMonsterGroup loadInstance(short groupID, String monstersIDs, String type, GWorld w){
		GMonsterGroup mg = new GMonsterGroup((short) StringUtils.count(monstersIDs, ','));
