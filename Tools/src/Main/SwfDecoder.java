	...
	public void readFully(byte[] b) throws Exception
	{
		...
		while (remain > 0)
		{
			...
			else
			{
				...
				throw new Exception("couldn't read " + remain);
			}
		}
	}
...
//                if (print) System.out.println("  read"+numBits+" " + result);
	...
	public int readSBits(int numBits) throws Exception
	{
		if (numBits > 32)
		{
			//throw new SwfFormatException("Number of bits > 32");
			throw new Exception("Number of bits > 32");
		}
	...
	public String readLengthString() throws Exception
	{
        int length = readUI8();
