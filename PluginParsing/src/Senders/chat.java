...
public class chat{
	 ...
	 */
	public static void cMK_Black(GPersonnage p,String msg)
	{
	...
	*/
	 ...
	 * @param guid - ID du perso envoyeur du message
	 */
	public static void cMK_Commerce(GPersonnage p,String msg)
	{
	 ...
	 */
	public static void cMK_ALL(GPersonnage p, char prefix, String msg)
	{
		for(GPersonnage perso : p.getServer().getWorld().getPersos().values()){
	 ...
	 * @param guid - ID du perso envoyeur du message
	 */
	public static void cMK_Recrutement(GPersonnage p,String msg)
	{
		for(GPersonnage perso : p.getServer().getWorld().getPersos().values()){
			send(perso.getClient().getSession(),"cMK?|"+p.getID()+"|"+p.getName()+"|"+msg);
		}
	 ...
	 */
	public static void cMK_Alignement(GPersonnage p,String msg)
	{
		for(GPersonnage perso : p.getServer().getWorld().getPersos().values()){
			if(perso.getAlignementSpecialization() == p.getAlignementSpecialization()){
				send(perso.getClient().getSession(),"cMK!|"+p.getID()+"|"+p.getName()+"|"+msg);
			}
		}
		msg = null;
	 ...
	 */
	 public static void cMK_Incarnam(GPersonnage p, String msg) 
	 { 
		 for(GPersonnage perso : p.getServer().getWorld().getPersos().values()){
				send(perso.getClient().getSession(),"cMK^|"+p.getID()+"|"+p.getName()+"|"+msg);
		 }
	 ...
	 *this.aks.Chat.onSmiley(sData.substr(2));
	 */
	public static void cS(GPersonnage p, int id)
	{
		for(ISprite z : p.getMap().getSpritesSynchroFull()){
			if(z.getCharacterType() == CharacterType.PLAYER){
